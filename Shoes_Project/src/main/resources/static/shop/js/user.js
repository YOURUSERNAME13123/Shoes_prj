    ...
    $("#registerForm").submit(function (e) {
        ...
        messages: {
            ...
            register_email: {
                required: "Vui lòng nhập email!",
                email: "Email không đúng định dạng!",
                maxlength: "Email có độ dài tối đa 35 ký tự!",
            },
            register_password: {
                required: "Vui lòng nhập mật khẩu!",
                rangelength: "Mật khẩu có độ dài từ 6-20 ký tự!"
        ...
        submitHandler: function () {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    // Hiển thị hộp thoại nhập mã OTP
                    var otp = prompt("Nhập mã OTP từ email của bạn:");

                    // Kiểm tra nếu người dùng đã nhập mã OTP
                    if (otp !== null) {
                        // Chuyển hướng đến trang xác minh với mã OTP
                        window.location.href = 'http://localhost/api/verify-user?token=' + otp;
                    }
